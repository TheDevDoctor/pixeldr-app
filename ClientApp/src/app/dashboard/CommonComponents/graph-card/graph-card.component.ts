...
@Component({
  selector: 'ngx-graph-card',
  styleUrls: ['./graph-card.component.scss'],
  template: `
    <nb-card size="xsmall" class="graphCard">
      <nb-card-header>Performance</nb-card-header>
      <nb-card-body>
...
export class GraphCardComponent implements AfterViewInit, OnDestroy {
